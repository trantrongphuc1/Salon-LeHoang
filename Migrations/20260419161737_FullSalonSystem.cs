...
{
    /// <inheritdoc />
    public partial class FullSalonSystem : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CommissionRate = table.Column<decimal>(type: "decimal(5,2)", nullable: false, defaultValue: 3m),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InvoiceDetails_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "EmployeeId");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PointHistories", x => x.HistoryId);
                    table.ForeignKey(
                        name: "FK_PointHistories_Invoices_InvoiceId",
                        column: x => x.InvoiceId,
                        principalTable: "Invoices",
                        principalColumn: "InvoiceId");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attendances_EmployeeId_AttendanceMonth_AttendanceYear",
                table: "Attendances",
                columns: new[] { "EmployeeId", "AttendanceMonth", "AttendanceYear" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_InvoiceDetails_EmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PointHistories_InvoiceId",
